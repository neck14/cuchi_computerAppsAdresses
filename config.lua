...
Config.Locale = "FR" -- EN/FR/ES/DA/DE
...
Config.DataHeists = {
    ...
    Reward = { 250, 500 }, -- random between [1] and [2]
    TypeOfDelay = "all", -- "each": one delay for each area OR "all": one delay for all areas
    Delay = 240, -- in minutes
    JobsToCall = { "lspd", "sheriff" }, -- jobs to send call when a heist is triggered
    Areas = {
